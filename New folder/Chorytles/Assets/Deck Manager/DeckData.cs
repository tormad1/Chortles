...
public class DeckData : MonoBehaviour
{
    ...
    void FillDeck()
    {
        DeckSlots = new List<Tuple<int, int, Vector2>>
        {
            ...
            Tuple.Create(1, Random.Range(0,Cards.Count) , new Vector2(-8, -2.5f)),
            Tuple.Create(2, Random.Range(0,Cards.Count) , new Vector2(-6.5f, -2.5f)),
            Tuple.Create(3, Random.Range(0,Cards.Count) , new Vector2(-5, -2.5f)),
            Tuple.Create(4, Random.Range(0, Cards.Count), new Vector2(-3.5f, -2.5f)),
            Tuple.Create(5, Random.Range(0, Cards.Count) , new Vector2(-2, -2.5f)),
            Tuple.Create(6, Random.Range(0, Cards.Count) , new Vector2(-0.5f, -2.5f)),
            Tuple.Create(7, Random.Range(0, Cards.Count) , new Vector2(1, -2.5f))
        };
    }
}
